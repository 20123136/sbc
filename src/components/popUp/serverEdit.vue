  ...
  <div class="edit-box" id="EditPop">
    <div class="edit">
      ...
      <div class="edit-body">
        <div class="edit-info">
          <label>记录ID</label>
          <input type="text" v-model="receiveData.switchId" disabled>
        </div>
        <div class="edit-info">
          <label>实例名</label>
          <input type="text" v-model="receiveData.switchName">
        </div>
        <div class="edit-info">
          <label>实例IP</label>
          <input type="text" v-model="receiveData.switchIp">
        </div>
        <div class="edit-info">
          <label>对外IP</label>
          <input type="text" v-model="receiveData.switchPublicIp">
        </div>
        <div class="edit-info">
          <label>端口</label>
          <input type="text" v-model="receiveData.switchConnectPort">
        </div>
        <div class="edit-info">
          <label>密码</label>
          <input type="text" v-model="receiveData.switchConnectPwd">
        </div>
        <div class="edit-info">
          <label>实例所在地</label>
          <input type="text" v-model="receiveData.switchPlace">
        </div>
...
<script>
    export default {
      ...
      methods:{
        ...
        put:function () {
          this.$http.post('/conf/rest/switch/update',{
            switchConnectPort:this.receiveData.switchConnectPort,
            switchConnectPwd:this.receiveData.switchConnectPwd,
            switchId:this.receiveData.switchId,
            switchIp:this.receiveData.switchIp,
            switchName:this.receiveData.switchName,
            switchPlace:this.receiveData.switchPlace,
            switchPublicIp:this.receiveData.switchPublicIp,
          }).then((data)=>{
