  ...
  <div class="edit-box" id="EditPop">
    <div class="edit">
      ...
      <div class="edit-body">
        <div class="edit-info">
          <label>用户Id</label>
          <input type="text" v-model="receiveData.userId" disabled>
        </div>
        <div class="edit-info">
          <label>用户名</label>
        ...
        <div class="edit-info">
          <label>姓名</label>
          <input type="text" v-model="receiveData.name">
        </div>
        <div class="edit-info">
          <label>Email</label>
          <input type="text" v-model="receiveData.email">
        </div>
        <div class="edit-info">
          <label>角色</label>
          <select v-model="receiveData.role">
  ...
  export default {
    ...
    methods:{
      ...
      fetchMonitor:function(){
        if(this.receiveData.role=="管理员"){
          this.receiveData.role="是"
        }else if(this.receiveData.role=="普通用户"){
          this.receiveData.role="否"
        }
      },
      put:function () {
        this.$http.post('/conf/rest/user/update',{
          email:this.receiveData.email,
          name:this.receiveData.name,
          pwd:this.receiveData.pwd,
          role:this.receiveData.role,
